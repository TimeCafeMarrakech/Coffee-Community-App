    ...
    res.status(200).send(`
      ...
      <html>
        ...
        <body style="font-family: sans-serif; padding: 2rem; text-align: center;">
          ...
          <p>The Node.js server is running successfully on Firebase App Hosting.</p>
          <p><em>Note: If you see this instead of the app, ensure index.html is in the root directory.</em></p>
        </body>
      </html>
    `);
  }
